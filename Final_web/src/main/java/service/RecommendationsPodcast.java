...
public class RecommendationsPodcast implements Irecomendations{
    ...
    public static void recommendationByGender() {
        ...
        get("/podcastRecommendationByGender", (req, res) -> plDef);
    }
    ...
    public static void recommendationByNationality() {
        ...
        get("/podcastRecommendationByNationality", (req, res) -> plDef);
    }
    ...
    public static void recommendationByArtist() {
        ...
        get("/podcastRecommendationByArtist", (req, res) -> plDef);
    }
    ...
    public static Playlist recommendationByPopularity() {
        ...
        get("/podcastRecommendationByPopularity", (req, res) -> pl);
